    ...
    <div>
      <header className="Home-header" style={{ backgroundImage: `url(${backgroundImages[currentBgIndex]})` }}>
        <div className="top-bar">
          ...
          <nav className="navigation">
            <Link to="/">HOME</Link>
            <Link to="/vehicle-listing">VEHICLE LISTING</Link>
            <Link to="/blog">BLOGS</Link>
            <Link to="/contact">CONTACT</Link>
            <button className='btn'><Link to="/contact">LOGIN</Link></button>
            <button className='btn'><Link to="/contact">SIGN UP</Link></button>
          </nav>
        </div>
            ...
            <div className="search-fields">
              ...
              <div className="search-field">
                <select>
                  ...
                  <option value="suv">Three weel</option>
                  <option value="suv">Scooter</option>
      ...
      <section className="contact-us">
        <div className="contact-info">
          ...
          <p className={animateLines ? 'animate-drop' : ''}>Email: shanthasovis73@gmail.com</p>
          <p className={animateLines ? 'animate-drop' : ''}>Phone: +94 777 845 830</p>
          <p className={animateLines ? 'animate-drop' : ''}>Address: Vishwa Transport (Pvt) Ltd, No 123, Araliya Street, Gampaha, Sri Lanka.</p>
        </div>
